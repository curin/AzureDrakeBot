...
namespace BotTest
{
    class Program
    {
        ...
        private static string login_name = "AzureDrakebot";
        private static string token = "oauth:0d85edjx1yag5ufwx0q65rskfh58un";//Environment.GetEnvironmentVariable("Token");  //Token should be stored in a safe place
        private static List<string> channels_to_join = new List<string>(new string[] { "AzureDrakebot" });
